...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    // ========================================================================
    // Language precedence: explicit override > profile preference > default 'en'
    const finalLang = lang ?? profile?.preferred_language ?? 'en';

    // ========================================================================
    // 6. Log AI Prompt Sent Event
    // ========================================================================
    try {
    ...
    // ========================================================================
    // 7. Generate Recipe with AI (with retry)
    // ========================================================================
    let recipe;
    try {
    ...
    // ========================================================================
    // 8. Log AI Recipe Generated Event
    // ========================================================================
