  ...
  describe("Form submission", () => {
    ...
    describe("Network errors", () => {
      it("should show network error on exception during login", async () => {
        ...
        vi.mocked(supabaseClient.auth.signInWithPassword).mockRejectedValueOnce(new Error("Network request failed"));
      ...
      it("should show network error on exception during registration", async () => {
        ...
        vi.mocked(supabaseClient.auth.signUp).mockRejectedValueOnce(new Error("Network request failed"));
